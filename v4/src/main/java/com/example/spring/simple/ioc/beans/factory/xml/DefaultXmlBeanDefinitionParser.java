...
import com.example.spring.simple.ioc.beans.factory.support.AbstractBeanDefinition;
import com.example.spring.simple.ioc.beans.factory.support.BeanDefinitionHolder;
import com.example.spring.simple.ioc.beans.factory.support.BeanDefinitionRegistry;
import com.example.spring.simple.ioc.beans.factory.support.ChildBeanDefinition;
import com.example.spring.simple.ioc.beans.factory.support.ManagedList;
import com.example.spring.simple.ioc.beans.factory.support.ManagedMap;
import com.example.spring.simple.ioc.beans.factory.support.ManagedSet;
...
public class DefaultXmlBeanDefinitionParser implements XmlBeanDefinitionParser {
    ...
    protected Map getMap(Element mapEle, String beanName) {
        ...
        Map map = new ManagedMap(list.size());  // a tag subclass of java.util.HashMap
        for (int i = 0; i < list.size(); i++) {
            Element entryEle = (Element) list.get(i);
            String key = entryEle.getAttribute(KEY_ATTRIBUTE);
            // hack: make more robust
