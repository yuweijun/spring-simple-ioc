...
/**
 * Editor for java.util.Properties objects. Handles conversion from String to Properties object. Also handles Map to Properties conversion, for populating a Properties object via XML "map" entries.
 *
...
public class PropertiesEditor extends PropertyEditorSupport {
    ...
    /**
     * Remove comment lines. We shouldn't need to do this, according to java.util.Properties documentation, but if we don't we end up with properties like "#this=is a comment" if we have whitespace before the comment marker.
     */
