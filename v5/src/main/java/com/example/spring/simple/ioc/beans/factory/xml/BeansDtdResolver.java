...
/**
 * EntityResolver implementation for the Spring beans DTD, to load the DTD from the Spring classpath resp. JAR file.
 *
 * <p>Fetches "spring-beans.dtd" from the classpath resource
 * "beans/factory/xml/spring-beans.dtd", no matter if specified as some local URL or as "http://www.springframework.org/dtd/spring-beans.dtd".
 *
...
public class BeansDtdResolver implements EntityResolver {
    ...
    private static final String SEARCH_PACKAGE = "/com/example/spring/simple/ioc/beans/factory/xml/";
