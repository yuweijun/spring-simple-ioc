...
import com.example.spring.simple.ioc.lang.Nullable;
...
public class RootBeanDefinition extends AbstractBeanDefinition {
     ...
     *
     * @throws IllegalStateException if the bean definition does not carry a resolved bean class
     */
     ...
     *
     * @param autowireMode the autowire to set. Must be one of the constants defined in this class.
     * @see #AUTOWIRE_NO
     ...
     * constructor arguments. This property should just be necessary for other kinds of dependencies like statics (*ugh*) or database preparation on startup.
     */
