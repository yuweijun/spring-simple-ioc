...
public abstract class AbstractBeanDefinition implements BeanDefinition {
    ...
    /**
     * Set if this a <b>Singleton</b>, with a single, shared instance returned on all calls. If false, the BeanFactory will apply the <b>Prototype</b> design pattern, with each caller requesting an instance getting an independent instance. How this is defined will depend on the BeanFactory.
